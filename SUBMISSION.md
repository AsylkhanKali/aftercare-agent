...
CopilotKit's Agents Everywhere starter kit: monorepo setup, CopilotKit runtime/provider wiring, and Exa search capability.
...
A person who feels unwell, does not know which clinic to contact, and wants help navigating the administrative steps.

**Why the context matters**

The assistant sees the current intake, safety assessment, clinic results, and approval state, so the user does not repeat sensitive details and remains in control of contact.
